...
$sheet->setCellValue('B3', 'APPLICANT INTER INSTITUTIONAL STATUS REPORT - ' . $this->common_model->get_academic_year()->row()->AYear);
...
$this->excel->Output("INTER INSTITUTION TRANSFER  STATUS");
exit;
?>
