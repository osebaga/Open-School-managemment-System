...
$sheet->setTitle("APPLICANTS VERIFICATION  LIST");
$sheet->setCellValue('B3', 'APPLICANTS VERIFICATION  STATUS REPORT- ' . $this->common_model->get_academic_year()->row()->AYear);
...
$this->excel->Output("APPLICANTS' VERIFICATION  STATUS");
exit;
?>
