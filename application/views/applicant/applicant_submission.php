<div class="ibox">
    ...
    <div class="ibox-content">
            ...
            <div class="col-md-5">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="no-borders">
                            <?php echo get_value('maritalstatus', $APPLICANT->marital_status, 'name'); ?></td>
                    </tr>
                    <tr>
            ...
            <div class="col-md-5">
                <table class="table">
                    <tr>
                        ...
                        <td class="no-borders">
                            <?php echo get_value('nationality', $APPLICANT->residence_country, 'Country'); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Disability :</th>
                        <td class="no-borders"><?php echo get_value('disability', $APPLICANT->Disability, 'name'); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th class="no-borders" style="width: 43%;">Primary School :</th>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="applicant_education_bg" style="margin-bottom: 50px;">
                    ...
                    <div
                        style="font-size: 16px; margin-bottom: 10px; border-bottom: 1px solid blue; width: 70%; color: blue; font-weight: bold;">
                        <?php echo entry_type_certificate($rowvalue->certificate); ?></div>
                    ...
                    <br />
                    <table cellpadding="0" cellspacing="0" class="table table-bordered" id="mytable" style="">
                        <thead>
                            <tr>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div
                    style="font-size: 14px; margin-bottom: 10px; border-bottom: 1px solid blue; width: 70%; color: blue; font-weight: bold;">
                    <?php echo $value1; ?></div>
                <?php
                        $tmp = '';
                        switch ($key1) {
    ...
    <tr>
            ...
            <div class="col-md-6">
                ...
                <table class="table">
                    <tr>
                        <th class="no-borders" style="width: 30%;">Name:</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[0]->name : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Mobile 1 :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[0]->mobile1 : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Mobile 2 :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[0]->mobile2 : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Email :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[0]->email : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Address :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[0]->address : ''); ?></td>
                    </tr>
            ...
            <div class="col-md-6">
                ...
                <table class="table">
                    <tr>
                        <th class="no-borders" style="width: 30%;">Name:</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[1]->name : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Mobile 1 :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[1]->mobile1 : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Mobile 2 :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[1]->mobile2 : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Email :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[1]->email : ''); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders">Address :</th>
                        <td class="no-borders">
                            <?php echo(isset($academic_referee) ? $academic_referee[1]->address : ''); ?></td>
                    </tr>
        ...
        <div class="row">
            <div class="col-md-6">
                <div style="font-weight: bold; color: blue; border-bottom: 1px solid blue; font-size: 15px;">Sponsor
                    Information
                </div>
                <table class="table">
                    <tr>
            ...
            <div class="col-md-6">
                <div style="font-weight: bold; color: blue; border-bottom: 1px solid blue; font-size: 15px;">Current
            ...
            <div class="col-md-12">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="no-borders">
                            <?php echo get_value('programme', array("Code" => $mycoice->choice1), 'Name'); ?></td>
                    </tr>
                    <!-- <tr>
                        <th class="no-borders" style="width: 20%;">Second Choice :</th>
                        <td class="no-borders">
                            <?php echo get_value('programme', array("Code" => $mycoice->choice2), 'Name'); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders" style="width: 20%;">Third Choice :</th>
                        <td class="no-borders">
                            <?php echo get_value('programme', array("Code" => $mycoice->choice3), 'Name'); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders" style="width: 20%;">Fourth Choice :</th>
                        <td class="no-borders">
                            <?php echo get_value('programme', array("Code" => $mycoice->choice4), 'Name'); ?></td>
                    </tr>
                    <tr>
                        <th class="no-borders" style="width: 20%;">Fifth Choice :</th>
                        <td class="no-borders">
                            <?php echo get_value('programme', array("Code" => $mycoice->choice5), 'Name'); ?></td>
                    </tr> -->
                </table>
                <?php } ?>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <div class="col-lg-offset-1" style="font-weight: bold; color: red; font-size: 14px;">
                        ...
                        <br />2. You will be able to make changes in your application e.g. change Programme Choices
