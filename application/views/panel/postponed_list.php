<?php
$current_print_title="DropOut LIST";
$current_file_name="dropout_list".date("Y-m-d");
...
<!--            </div>-->
            ...
            <div class="table-responsive">
                ...
                <thead>
                    ...
                    <?php
                   $i=0;
                    foreach ($postponed_list as $key => $value) {
                        $i=$i + 1;
                        ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;"><?php echo $value->registrtionnumber; ?></td>
