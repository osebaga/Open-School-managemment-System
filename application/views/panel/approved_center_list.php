...
<div class="ibox">
    ...
    <div class="ibox-content">
        <?php echo form_open(site_url('approved_center_list'), ' method="GET" class="form-horizontal ng-pristine ng-valid"') ?>
        ...
        <div class="table-responsive">
            ...
            <thead>
                ...
                foreach ($center_list as $applicant_key => $applicant_value) { 

                    ?>
                
                    <tr>
                      <td style="text-align: right;"><?php  echo $page++; ?></td>
                      <td style="text-align: center;"><?php echo $applicant_value->approved_date; ?></td>

                      <td>
                            <?php
                            if(isset($applicant_value->CenterRegNo) and $applicant_value->CenterRegNo!='')
                            {
                                echo '<a href="javascript:void(0);" style="display: block;" class="center_regno" ID="'.$applicant_value->id.'" CenterName="'.$applicant_value->CenterName.'" CenterOwner="'.$applicant_value->CenterOwner.'" CenterCordinator="'.$applicant_value->CenterCordinator.'" SELECTED_ID="'.$applicant_value->CenterRegNo.'" SELECTED_VALUE="'.$applicant_value->CenterRegNo.'" >'.$applicant_value->CenterRegNo;
                            }
                            else
                            {
                                echo '<a href="javascript:void(0);" style="display: block;" class="center_regno" ID="'.$applicant_value->id.'" CenterName="'.$applicant_value->CenterName.'" CenterOwner="'.$applicant_value->CenterOwner.'" CenterCordinator="'.$applicant_value->CenterCordinator.'" SELECTED_ID="'.$applicant_value->CenterRegNo.'" SELECTED_VALUE="'.$applicant_value->CenterRegNo.'" >'.'No Center No.';
                            }                         
                               ?></a>
                        </td>                     
                        ...
                        <td style="text-align: center;"><?php echo get_value('regions',$applicant_value->region,"name"); ?></td>
                        ...
                        <td> <?php echo '<a href="javascript:void(0);" style="display: block; color: green;" class="approvalstatus" ID="'.$applicant_value->id.'" CenterName="'.$applicant_value->CenterName.'" CenterOwner="'.$applicant_value->CenterOwner.'" CenterCordinator="'.$applicant_value->CenterCordinator.'" SELECTED_ID="'.$applicant_value->submitted.'" SELECTED_VALUE="'.application_status($applicant_value->submitted).'" ><b>'.application_status($applicant_value->submitted);?></b></a> </td>
