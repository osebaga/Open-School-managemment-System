                ...
                foreach ($applicant_list as $applicant_key => $applicant_value) {
                    ...
                    <tr>
                      ...
                      title="'.$applicant_value->FirstName.' '.$applicant_value->MiddleName.' '.$applicant_value->LastName.'">'. $applicant_value->FirstName.' '.$applicant_value->MiddleName.' '.$applicant_value->LastName; ?></a></td>
                        <td><?php echo $applicant_value->status; ?></td>
                        <td><?php echo $applicant_value->description; ?></td>
                        <td style="width: 60px;"><a href="<?php echo site_url('logs/tcu_retry/'.encode_id($applicant_value->id)) ?>">Retry</a></td>
                        <td style="width: 60px;"><a href="<?php echo site_url('logs/change_status/'.encode_id($applicant_value->id)) ?>">Change status</a></td>
