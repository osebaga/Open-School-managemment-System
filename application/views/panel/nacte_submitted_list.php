...
<!--            </div>-->
            ...
            <div class="table-responsive">
                ...
                <thead>
                    ...
                    <?php
                   $i=0;
                    foreach ($nacte_list as $key => $value) {
                        $i=$i + 1;
                        ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;"><?php echo $value->f4_index.'/'. $value->f4_year; ?></td>
                            <td style="text-align: left;"><?php echo $value->code; ?></td>
                            <td style="text-align: left;"><?php echo $value->message; ?></td>
                            <td style="text-align: left;"><?php echo $value->programme_code; ?></td>
                            <td style="text-align: left;"><?php echo $value->a_year; ?></td>
                            <td style="text-align: left;"><?php echo'<pre>'. $value->request .'</pre>'; ?></td>
                        </tr>
