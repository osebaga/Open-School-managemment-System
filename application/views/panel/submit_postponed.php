...
<div class="ibox float-e-margins">
    <div class="ibox-title clearfix">
        <h5>Import Student PostPoned</h5>
    ...
    <div class="ibox-content">
        ...
        <div class="form-group">
            <div class="col-lg-8 col-lg-offset-3">
                <a href="../uploads/docs/Submit-postponed-students.xlsx">Download Template</a>
            </div>
        </div>

        <div class="form-group"><label class="col-lg-3 control-label">Student Postponement Sheet : <span
        ...
        <div class="form-group">
            <div class="col-lg-offset-3 col-lg-8">
                <input class="btn btn-sm btn-success" type="submit" value="Submit Postponed Students"/>
            </div>
        </div>
        <?php echo form_close(); ?>
