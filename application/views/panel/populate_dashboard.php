    ...
    <div class="ibox-content">
        ...
        <div class="form-group">
            <div class="col-lg-8 col-lg-offset-3">
                <a href="../uploads/docs/submited-summary.xlsx">Download Template</a>
            </div>
        </div>


        <div class="form-group"><label class="col-lg-3 control-label">Summary Sheet : <span
        ...
        <div class="form-group">
            <div class="col-lg-offset-3 col-lg-8">
                <input class="btn btn-sm btn-success" type="submit" value="Import Submitted Summary"/>
            </div>
        </div>
        <?php echo form_close(); ?>
