...
$config['user_expire']                = 5000;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['lockout_time']               = 180;                 // The number of seconds to lockout an account due to exceeded attempts
